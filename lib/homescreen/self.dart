        ...
        children: <Widget>[
          ...
          Padding(
           ...
           SizedBox(
            ...
            Text("Wished Accreditations Code"),
            SizedBox(height: 15),
            Padding(
              padding: const EdgeInsets.all(10.0),
              child: Container(
             ...
             SizedBox(height: 20),
                ...
                SizedBox(height: 20),
                Text("Standards Sub Chapter Name: "),
                SizedBox(height: 15),
                Padding(
                  padding: const EdgeInsets.all(10.0),
                  child: Container(
                  ...
                  child: Container(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        labelText: "Objective Element Code",
                      ),
                    ),
                  ),
                ),
                SizedBox(height: 20),
                Text("Objective Element Name: "),
                SizedBox(height: 15),
                Padding(
                  padding: const EdgeInsets.all(10.0),
                  child: Container(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        icon: Icon(Icons.short_text),
                        labelText: "Objective Element Name",
                      ),
                    ),
                  ),
                ),
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        icon: Icon(Icons.short_text),
                        labelText: "Judgement Element",
                      ),
                    ),
                  ),
                ),
                SizedBox(height: 20),
                Text("Judgement Element Description: "),
                SizedBox(height: 15),
                Padding(
                  padding: const EdgeInsets.all(10.0),
                  child: Container(
